    ...
    <>
      <section className="about">
        <figure>
          <Animation animationClass="slideInLeft">
            <img src="/public/aboutbillede.webp" alt="Billede af mig" />
          </Animation>
        </figure>
        <article>
      ...
      <section className="programmer">
        ...
        <Animation animationClass="slideInBottom">
          <div className="program-wrapper">
            <figure>
              <img src="/public/html.svg" alt="HTML Logo" />
              <figcaption>HTML5</figcaption>
            </figure>

            <figure>
              <img src="/public/css.svg" alt="CSS Logo" />
              <figcaption>CSS3</figcaption>
            </figure>

            <figure>
              <img src="/public/js.svg" alt="JavaScript Logo" />
            ...
            <figure>
              <img src="/public/githubblaa.svg" alt="GitHub Logo" />
              <figcaption>GitHub</figcaption>
            </figure>

            <figure>
              <img src="/public/vsc.svg" alt="Visual Studio Code Logo" />
              <figcaption>VSC</figcaption>
            </figure>

            <figure>
              <img src="/public/ps.svg" alt="Photoshop Logo" />
              <figcaption>Photoshop</figcaption>
            </figure>

            <figure>
              <img src="/public/ai.svg" alt="Illustrator Logo" />
              <figcaption>Illustrator</figcaption>
            </figure>

            <figure>
              <img src="/public/figma.svg" alt="Figma Logo" />
      ...
      <section className="udtalelser">
        ...
        <div className="udtalelse-wrapper">
          <article>
            <Animation animationClass="slideInLeft">
              <img src="/public/valdemar.webp" alt="Billede af Valdemar" />
              <h3>Valdemar Berg</h3>
              <h4>Tidl. kollega</h4>
              <p>
          ...
          <article>
            <Animation animationClass="slideInBottom">
              <img src="/public/louise.webp" alt="Billede af Louise" />
              <h3>Louise Thysen</h3>
              <h4>Medstuderende</h4>
              <p>
