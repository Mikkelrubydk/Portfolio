        ...
        <div className="kompetencecontainer">
          <Animation animationClass="slideInLeft">
            <article>
              <h3>Programmering</h3>
              <div>
                <img src="/public/coding.webp" alt="Coding Icon" />
                <p>
          ...
          <Animation animationClass="slideInLeft">
            <article>
              <h3>UX/UI Design</h3>
              <div>
                <img src="/public/ux-design.webp" alt="UX/UI Icon" />
                <p>
          ...
          <Animation animationClass="slideInLeft">
            <article>
              ...
              <div>
                <img
                  src="/public/responsive-design.webp"
          ...
          <Animation animationClass="slideInLeft">
            <article>
              ...
              <div>
                <img src="/public/web-design.webp" alt="Web Design Icon" />
                <p>
